            ...
            <div class="nav-bar">
                <div class="brand">
                    <a class="nav-link" href="../home/home.php#hero">
                        <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;">The Hungry Plate</h1><span
                            class="sr-only"></span>
                    </a>
                </div>
                <div class="nav-list">
...
?>
                               <li><a href="/RestaurantProject/customerSide/home/home.php#hero">HOME</a></li>
<?php
