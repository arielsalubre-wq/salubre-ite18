...
.wrapper{ 
    ...
    padding-left: 200px; 
    padding-top: 20px;  
    background:#f5f5f5;   /* POS light background */
    min-height:100vh;
}

/* OPTIONAL: if wrapper contains cards/sections */
...
/* OPTIONAL CARD STYLE (if used inside wrapper) */
.card{
    background:#fff;
    border:1px solid #ddd;
